...
//		JTable tableView = new JTable((TableModel) _courseModel);
...
//		JTable tableView = new JTable(new CourseAdapter(_courseModel));
        JTable tableView = new JTable(tableModel);
        _courseModel.addCourseListener(graphView);
        _courseModel.addCourseListener(statsView);
        _courseModel.addCourseListener(tableModel);
